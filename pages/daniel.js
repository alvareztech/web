          ...
          <div className="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
            ...
            <div className="mt-8 lg:mt-0">
              ...
              <div className="mt-5 prose prose-indigo text-gray-500 mx-auto lg:max-w-none lg:row-start-1 lg:col-start-1">
                ...
                <h3>How we helped</h3>
                <p>
                  <div className="badge-base LI-profile-badge" data-locale="es_ES" data-size="medium" data-theme="dark" data-type="VERTICAL" data-vanity="alvareztech" data-version="v1">
                    <a className="badge-base__link LI-simple-link" href="https://mx.linkedin.com/in/alvareztech?trk=profile-badge">Daniel Alvarez</a>
                  </div>
                </p>
                <p>
