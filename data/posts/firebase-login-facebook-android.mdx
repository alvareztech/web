...
summary: Inicio de sesión con Facebook usando Firebase Authentication.
...
Inicio de sesión con _Facebook_ en tu aplicación Android usando _Firebase Authentication_ y además obtendrás la información del usuario.
