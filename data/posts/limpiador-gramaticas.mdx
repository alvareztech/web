...
summary: Aplicación de escritorio escrita en Java que limpia una gramática eliminando las producciones renombradoras, las producciones inútiles y las producciones inaccesibles.
tags: [java]
