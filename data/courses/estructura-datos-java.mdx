...
* [Imprimir](https://alvarez.tech/labs/javafx-printing) (Lab)
...
[Generar un gráfico Pie con JavaFX](https://alvarez.tech/labs/generar-piechart-javafx)
...
* El usuario al presionar el botón esta jugando con la computadora, la computadora debe usar una de las tres opciones al azar.
...
Se tiene una memoria USB (pendrive) que almacena varios archivos en un cola simple. Cada archivo tiene un nombre, extensión, peso en KB (por ejemplo 232.5 KB).
...
Se tiene una memoria USB (pendrive) que almacena varios archivos en un cola simple. Cada archivo tiene un nombre, extensión, peso en MB (por ejemplo 2.7 MB).
Se pide realizar lo siguiente:
...
2. Hacer un cálculo para ver cuánto se ganará si se vende todo los disfraces para vender 
